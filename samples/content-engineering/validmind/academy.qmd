...
The first of my new series of four developer demonstration notebooks, with concepts spilt out to match each module of the training curriculum, and a hidden top navigation when embedded into the training:[^dev-notebooks-link]
