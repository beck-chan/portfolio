...
I've also written a couple of Quarto Extensions^[**Quarto:** [Extensions](https://quarto.org/docs/extensions/){target="_blank"}] in Lua for custom functionality I found myself reusing and wanted to simplify the implementation of.

::: {.panel-tabset}

### Code Folding

Quarto's build-in option for folding code^[**Quarto:** [HTML Code Blocks](https://quarto.org/docs/output-formats/html-code.html#folding-code){target="_blank"}] only covers executable cell output. This extension allows non-executable fenced code blocks to be wrapped in a `<details>` toggle used below:^[**{{< fa brands github >}} beck-chan/portfolio/`_`{=html}extensions/beck-chan/:** [fold-code.lua](https://github.com/beck-chan/portfolio/blob/main/_extensions/beck-chan/fold-code/fold-code.lua){target="_blank"}]
...
Embeds an iframe with a fenced div with options to include a caption under the iframe, as well as adjust zoom, sizing, and loading configurations:^[**{{< fa brands github >}} beck-chan/portfolio/`_`{=html}extensions/beck-chan/:** [iframe.lua](https://github.com/beck-chan/portfolio/blob/main/_extensions/beck-chan/iframe/iframe.lua){target="_blank"}]
